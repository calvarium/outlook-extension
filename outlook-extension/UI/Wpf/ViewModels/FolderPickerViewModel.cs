...
namespace outlook_extension.UI.Wpf.ViewModels
{
    public class FolderPickerViewModel : ViewModelBase
    {
        ...
        public FolderPickerViewModel(FolderService folderService, SearchService searchService)
        {
            ...
            ConfirmCommand = new RelayCommand(ConfirmSelection, () => SelectedResult != null);
        ...
        public Action<FolderInfo> SelectionConfirmed { get; set; }
        ...
        public void HandleNavigation(int delta)
        {
            ...
            var newIndex = Math.Max(0, Math.Min(Results.Count - 1, currentIndex + delta));
        ...
        private void ConfirmSelection()
        {
            ...
            SelectionConfirmed?.Invoke(SelectedResult.Info);
            CloseRequested?.Invoke();
        }
